...
@section('content')
    ...
    <div class="card-body fw-bold">
        <form action="{{ url('/admin/produk') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label>Harga</label>
                <input type="number" name="harga" class="form-control" placeholder="Tulis harga kacamata..." required>
            </div>
            <div class="mb-3">
                <label>Stok</label>
            ...
            <div class="mb-3">
                ...
                <textarea name="deskripsi" class="form-control" rows="3"
                    placeholder="Contoh: Frame plastik berkualitas, lensa anti radiasi..."></textarea>
            </div>
            <div class="mb-3">
                <label>Foto Produk</label>
                <input type="file" name="foto_produk" placeholder="Tambahkan foto yang sesuai..." class="form-control">
            </div>
